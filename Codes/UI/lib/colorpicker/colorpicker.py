...
from .UI_ColorPicker_Edited import Ui_ColorPicker
...
class ColorPicker(QDialog):
    ...
    def __init__(self, name, **kwargs):
        ...
        self.ui.buttonBox.accepted.connect(self.accept) # 확인 누르면 1(Accepted) 반환
        self.ui.buttonBox.rejected.connect(self.reject) # 취소 누르면 0(Rejected) 반환
    ...
    def getResult(self):
        return self.ui.lineEdit.text(), self.getHex(True)
